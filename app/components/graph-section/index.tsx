  ...
  return (
   ...
   grid-cols-1 py-[31px] lg:px-[41px] px-[20px] gap-[22px]  '
    >
      <div className='lg:flex-col lg:flex lg:order-1 order-2 gap-2 grid  grid-cols-1 lg:mt-0 mt-5'>
        ...
        <div>
          ...
          <div className='mt-[24px] text-sm'>
            <span className='flex justify-between p-[12px] border-t border-white/15'>
              Pair{' '}
      ...
      <article className='flex-1 lg:order-2 order-1 '>
        <Image
          src={'/graph.png'}
          alt='graph'
          width={1031}
        ...
        />
        <div className='lg:block hidden mt-[94px] font-[400] text-base text-[#F4EAEA] max-w-[641px]'>
          <p className='mb-[13px]'>Reshape Your Vision 🚀</p>
          ReMorph AI is a cutting-edge Web3 AI platform designed to empower
          developers, creators, and traders by combining AI-driven tools with
          on-chain utility. From seamless token launches to AI-powered Business
          Development tools, ReMorph enhances project growth and execution.
          <p className='mb-[13px] lg:mt-[48px] mt-[20px]'>💡 Why ReMorph?</p>
          ✅ AI-powered tools for Web3 Business Development <br />✅ Seamless
          token launches with integrated KYC & Proof of Funds verification ✅
          Future-ready Launchpad with enhanced security and compliance Join us
          as we reshape the future of AI and crypto.
        </div>
      </article>
      <div className='lg:hidden mt-[30px] font-[400] text-base text-[#F4EAEA] order-3'>
        <p className='mb-[13px]'>Reshape Your Vision 🚀</p>
        ReMorph AI is a cutting-edge Web3 AI platform designed to empower
        developers, creators, and traders by combining AI-driven tools with
        on-chain utility. From seamless token launches to AI-powered Business
        ...
        ✅ AI-powered tools for Web3 Business Development <br />✅ Seamless
        token launches with integrated KYC & Proof of Funds verification ✅
        Future-ready Launchpad with enhanced security and compliance Join us as
        we reshape the future of AI and crypto.
      </div>
    </section>
  )
}
