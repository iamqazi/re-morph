  ...
  return (
    <section
      className="bg-[#100B4E33] mb-[100px] font-inter border-r-0 border-l-0 border border-white/20 
        grid lg:grid-cols-[auto_1fr] grid-cols-1 py-[31px] px-4 sm:px-[20px] lg:px-[41px] gap-4 relative overflow-hidden max-w-[1400px] mx-auto"
    >
        ...
        <div className="flex flex-col gap-3">
          <div className="gap-3 text-sm capitalize text-[#DEDDFF] grid grid-cols-3">
            <span className="border border-white/15 bg-[#7E61FF1A] rounded-[6px] shadow-[inset_0px_0px_10px_0px_#FFFFFF1A] flex flex-col px-[10px] py-[5px] items-center text-sm">
              1H
              <span className="text-[#09FF00] text-base font-[600]">24.7%</span>
            </span>
            <span className="border border-white/15 bg-[#7E61FF1A] rounded-[6px] shadow-[inset_0px_0px_10px_0px_#FFFFFF1A] flex flex-col px-[10px] py-[5px] items-center text-sm">
              6H
              <span className="text-[#09FF00] text-base font-[600]">13.4%</span>
            </span>
            <span className="border border-white/15 bg-[#7E61FF1A] rounded-[6px] shadow-[inset_0px_0px_10px_0px_#FFFFFF1A] flex flex-col px-[10px] py-[5px] items-center text-sm">
              12H
      ...
      <div className="flex-1 lg:order-2 order-1 mt-[40px] xl:mt-0 min-w-0">
        <Image
          src={"/graph.png"}
          alt="graph"
          width={1031}
          height={571}
          className="bg-no-repeat bg-center bg-cover rounded-[10px] w-full select-none min-h-[250px] object-cover"
        />
